                ...
                <div className="about-profile">
                  <ul className="admin-profile">
                    <li>
                      ...
                      <span className="pro-detail">Tom Saulnier</span>
                    </li>
                    <li>
                      <span className="pro-title"> Age </span>{" "}
                      <span className="pro-detail">25 Years</span>
                    </li>
                    <li>
                    ...
                    <li>
                      ...
                      <span className="pro-detail">USA</span>
                    </li>
                    <li>
                      <span className="pro-title"> Location </span>{" "}
                      <span className="pro-detail">San Francisco, CA</span>
                    </li>
                    <li>
                      <span className="pro-title"> e-mail </span>{" "}
                      <span className="pro-detail">email@example.com</span>
                    </li>
                    <li>
                      <span className="pro-title"> Phone </span>{" "}
                      <span className="pro-detail">+ (00) 123 456 789</span>
                    </li>
                    <li>
